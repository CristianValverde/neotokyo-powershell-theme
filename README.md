[README.md](https://github.com/user-attachments/files/28283897/README.md)
...
- **PowerShell:** Windows PowerShell 5.1+ (PowerShell 7.4+ recommended)
...
|-----------|---------|-------------|--------------|
| **PowerShell 7.4+** | Latest | Modern cross-platform PowerShell | ✅ Yes |
...
| Situation | Action |
|-----------|--------|
| **No PowerShell 7** | ➡️ Installs PowerShell 7.4+ automatically |
| **PowerShell 7.0-7.3** | ➡️ Asks if you want to upgrade to 7.4+ |
| **PowerShell 7.4+** | ➡️ Continues without asking ✅ |
